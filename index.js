...
var changeBack = new MutationObserver(function(styleChanges)
	...
	styleChanges.forEach(function(styleChange)
		...
		switch(element.tagName)
			{
			case "IMG": case "P": case "H1": case "H2": case "H3": case "A": case "EM": case "SPAN": case "SVG": case "PICTURE": case "HEADER": case "SECTION": case "FOOTER": case "ARTICLE": case "BODY": case "HTML":
